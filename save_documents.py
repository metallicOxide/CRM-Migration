...
CHROME_DOWNLOAD = "C:\\Users\\usr\\Downloads"
DOWNLOAD_FOLDER_PATH = "C:\\Users\\usr\\Downloads\\ClientDocs"
...
def downloadDocs(driver, client_URL, DOC_URL):
    ...
    non_openlist = ['DOCX', 'XLSX', 'DOC', 'MOV', 'ODT', 'TIFF', 'ZIP', 'PPTX']
    ...
    # while iterator < numFiles:
    #     Xpath = generateXPATH(iterator + 1, numFolder)
    #     try:
